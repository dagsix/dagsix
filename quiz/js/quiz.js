  ...
  */
      ...
      */
      ...
      $("#answer1").click(function () {
          ...
          scores(answers[currentRound][1],1);
      });
      ...
      */
      ...
      $("#answer2").click(function () {
        ...
        scores(answers[currentRound][2],2);
      });
      ...
      */
      ...
      $("#answer3").click(function () {
        ...
        scores(answers[currentRound][3],3);
      });
      ...
      ***********************************
      */
      function scores(choice,position) {
          var j, graphic, temp, a1, a2;
          // $("#answer1, #answer2, #answer3").removeClass("purple");
          $("#next").show();
         
                  a1= theanswer[0];
                  // test for second answer
                  if (theanswer[currentRound][1]!='undefined') 
                  {
                    a2=theanswer[currentRound][1];
                  }
                else
                  {
                    a2="";
                ...
                else
                  {
                    // wrong answer
                      graphic = "answer" + position + "gfx";
                      console.log("updating graphic: " + graphic);
                      $("#" + graphic).empty().append("<i class='fas fa-times-circle'></i></i>");
                      $("#" + graphic).css({
